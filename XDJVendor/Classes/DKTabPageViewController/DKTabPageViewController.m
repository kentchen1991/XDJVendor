...
//改by csh 4。11
NSString *const XDJOrdervcPopNotification = @"XDJOrdervcPopNotification";
...
#pragma mark add by csh 2.3.16
//- (BOOL)slideDrawer:(UIScrollView*)scrollView {
//    CGPoint contentOffset = scrollView.contentOffset;
//    if (contentOffset.x < -20) {
////        [[SlidingManager sharedManager] openTheDrawer];
//        [[NSNotificationCenter defaultCenter] postNotificationName:XDJOrdervcPopNotification object:nil];
//        return YES;
//    } else {
//        return NO;
//    }
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    //add by csh 2.3.16
//    if ([self slideDrawer:scrollView]) return;
